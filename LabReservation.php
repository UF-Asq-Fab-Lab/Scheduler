...
class LabReservation extends Page {
   ...
   * are edited only from the Charger section.
	...
	public function editUrl() {
		return str_replace('/page/edit/',
                       '/lab_scheduler/lab_reservations/edit/',
                       parent::editUrl());
	}
   ...
   * of /charger/lab_charges/
	...
	public function ___setEditor(WirePageEditor $editor) {
		...
		if(!$editor instanceof ProcessLabReservation) $this->wire('session')->redirect($this->editUrl());
	}
  ...
  /**
	...
	public function getPagesManager() {
		return $this->wire('lab_reservations');
	}
